...
/*
AT+Command List
Depended on the parameters given with the AT command, different functions are called
format:
	command, length of command, testfunction (AT+<C>=?), queryfunction(AT+<C>?), setupfunction (AT+<C>="x"), executefunction (AT+<C>)
*/
...
at_funcationType at_fun[at_cmdNum]={
  ...
  {"+CSTARTLOG", 10, NULL, NULL, at_setupCmdCipStartLog, NULL},
  {"+CSTOPLOG", 9, NULL, NULL, NULL, at_exeCmdStopLog},
  {"+HELP", 5, NULL, NULL, NULL, at_exeCmdHelp}
};
